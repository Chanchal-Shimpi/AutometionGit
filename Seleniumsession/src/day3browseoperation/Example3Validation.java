...
public class Example3Validation {
	...
	public static void main(String[] args) {
		...
		System.out.println(
	    "Username input field, default text displayed: " + userNameInputField.getAttribute("placeholder"));
...
/*
 * Username: visible or not --->isDisplayed() editable or not--->isEnabled()
 * default value--->getAttribute("placeholder")
 * 
 * keep me logged in check: displayed or not--->isDisplayed() clickable or
 * not--->isEnabled() default selection--->isSelected() after selection validate
 * again--->isSelected()
 * 
 * Login button: visible or not--->isDisplayed() clickable or not--->isEnabled()
 * button name--->getText()
 */
